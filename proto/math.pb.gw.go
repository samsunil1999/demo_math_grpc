...
func RegisterMathServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MathServiceServer) error {
	...
	mux.Handle("POST", pattern_MathService_Multiply_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/math_service.MathService/Multiply", runtime.WithHTTPPathPattern("/v1/multiply"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MathService_Divide_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/math_service.MathService/Divide", runtime.WithHTTPPathPattern("/v1/divide"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMathServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MathServiceClient) error {
	...
	mux.Handle("POST", pattern_MathService_Multiply_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/math_service.MathService/Multiply", runtime.WithHTTPPathPattern("/v1/multiply"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MathService_Divide_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/math_service.MathService/Divide", runtime.WithHTTPPathPattern("/v1/divide"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
